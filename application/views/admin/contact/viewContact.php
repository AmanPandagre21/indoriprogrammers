    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><a href="<?php echo base_url().'admin/Contact/index'; ?>">Contact</a></li>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card card-primary card-outline">
          ...
          <a href="<?php echo base_url().'admin/Contact/update_status/'.$Userinfo['id']; ?>" class="btn btn-danger btn-block" style="font-size: 20px;">SEEN</a>
          </div>
        </div><!-- /.card -->
      </div>
    </div>
